...
//
// WriteBatch holds a collection of updates to apply automically to a DB.
//
...
//  extenal synchronization, but if any of the threads may call a 
//  non-const method, all thread accessing the same WriteBatch must use
